...
const experiences = [
  {
    ...
    startDate: new Date("06/19/2022"),
    endDate: null,
    achievements: [
      "Work on a system for back office users and affiliates that allow to mange campaigns, manage financial resources and run reports.",
      "Add a variety of business requirements and develop new features ex:(commission manager, daily tips, referral program)",
      "Practice on code review, application consistency and unit testing",
      "Using Vue, Vuex, Sass, localization"
    ],
  },
  {
    id: "2",
    ...
    achievements: [
      "Build from scratch an art generator web app using AI that allow user to create a piece of art from text.",
      "Support any production bug.",
      "Using React, typescript, Apollo Clint",
    ],
  },
  {
    id: "3",
    company: "BeClarified",
    title: "Frontend developer",
    startDate: new Date("11/07/2021"),
    endDate: new Date("06/05/2022"),
    achievements: [
      " Build from scratch a dental management software that provide appointment confirmation , lab management, finical invoices and stock management.",
      " Using React, typescript, Redux , React-table, React hook form",
    ],
  },
  {
    id: "4",
    ...
    endDate: new Date("11/01/2021"),
    achievements: [
      "Developing and maintaining a variety of responsive web pages using React.",
